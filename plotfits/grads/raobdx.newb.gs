...
if(quan=1); var=t; titvar='Temperature'; count=tcnt; rmsd='trmse*trmse'; bias='tbias'; yrmsd=0.5; ybias=1.0; leve=15; endif
if(quan=2); var=q; titvar='SpecificHum'; count=qcnt; rmsd='qrmse*qrmse'; bias='qbias'; yrmsd=0.5; ybias=1.0; leve=15; endif
if(quan=3); var=z; titvar='Geop Height'; count=zcnt; rmsd='zrmse*zrmse'; bias='zbias'; yrmsd=15.; ybias=15.; leve=15; endif
if(quan=4); var=w; titvar='Wind Vector'; count=wcnt; rmsd='wrmse*wrmse'; bias='wbias'; yrmsd=2.0; ybias=15.; leve=15; endif
