...
c
       ...
       real(8) sprs(nreg,nsub,nlev,nstcw,nvar,ntx),cnt,avg,rms
...
c
      ...
      do ivar=1,nvar
      do ilev=1,nlev
      print'(3i4,7f8.2)',nt,ivar,ilev,out(:,nt,ilev,ivar,1)
      print'(3i4,7f8.2)',nt,ivar,ilev,out(:,nt,ilev,ivar,2)   
      print'(3i4,7f8.2)',nt,ivar,ilev,out(:,nt,ilev,ivar,3)    
      enddo;enddo;enddo
      call bort('test')
      endif
